...
import css from './ActivityCreation.module.css';
  ...
  return (
    <div className={css.container}>
      ...
      >
        ...
        <select
          className={css['select-countries']}
          name="inputCountries"
          id="forCountries"
          onChange={(e) => handleInputChange(e)}
        >
        ...
        <button className={css['create-btn']} type="reset" onClick={restart}>
          RESTART
        </button>
      ...
      <div className={css['container-link']}>
      ...
      <div className={css['container__section']}>
        <section className={css.section}>
          <h1 className={css.section__title}>My Activity</h1>
          ...
          <div className={css['container__section-countries']}>
            Countries:
