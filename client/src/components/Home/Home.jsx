...
import { getCountries, getActivities, filterByArea, filterByAlphabet, filterCountryByContinent } from '../../actions';
...
export default function Home() {
  ...
  // Disparar acciones y obteniendo y guardando datos previamente a que la pagina se renderize.
  useEffect(() => {
    setLoading(true);
